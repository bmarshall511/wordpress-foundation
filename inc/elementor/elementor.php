...
/**
 * Main Elementor Foundation Class
 *
 * The init class that runs the Foundation plugin.
 ...
 * @since 1.0.0
 */
final class Elementor_Foundation {
	...
	public function init() {
		...
		// Once we get here, We have passed all validation checks so we can safely include our Foundation widgets
...
// Instantiate Elementor_Foundation.
new Elementor_Foundation();
